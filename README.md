## domain_bridge (humble) - 0.5.0-1

The packages in the `domain_bridge` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble domain_bridge` on `Thu, 12 May 2022 18:10:01 -0000`
